				...
				<div id="content">
					<div class="post">
						...
						<div class="entry"> 
							...
							$result = mysqli_query($con,"SELECT incident_id, summary_t, assigned_date, Person_assigned FROM zefer_ticket");
							...
							<div id="ticket">
								...
								<?php
								$con = mysqli_connect("10.8.82.253","10.8.82.253","savemegod","cbs");
								$result = mysqli_query($con,"SELECT incident_id FROM zefer_ticket");
								while($row = mysqli_fetch_array($result))
								{
									echo "<option value='";
									echo $row['incident_id'];
