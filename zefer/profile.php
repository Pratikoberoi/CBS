	...
	<div id="bg4">
		<div id="bg5">
			<div id="page">
				...
				echo "</td>";
				echo "<td>Agent ID</td>";
				echo "<td><input type='text' class='text' value='";
				$agentid = "";
				$result = mysqli_query($con,"SELECT * FROM $tablename WHERE user_id = '$login'");
				while($row = mysqli_fetch_array($result))
				{
				...
				echo "<td><input type='text' class='text' id='datepicker' value='";
				$dob = "";
				$result = mysqli_query($con,"SELECT * FROM $tablename WHERE user_id = '$login'");
				while($row = mysqli_fetch_array($result))
				{
				...
				echo "</tr>"; 
				echo "<tr>";
				echo "<td><input type='button' value='Upload Image' class='button2' /></td>";
				echo "<td>Email ID</td>";
				echo "<td><input type='text' class='text' value='";
				$Email = "";
				$result = mysqli_query($con,"SELECT * FROM $tablename WHERE user_id = '$login'");
				...
				echo "</tr>"; 
				echo "<tr>";
				echo "<td><input type='button' value='Change Password' class='button2' /></td>";
