      ...
      <div id="header">
        ...
        <div class="row-2">
          <ul>
            ...
            <li class="m3"><a href="#" class="active">Modification</a></li>
        ...
        <!-- Main Content -->
		<div id="searchurl1">
		<div id="signup1"><br /><h1>Front end &nbsp; :</h1><br />
            <form action="" method="post">
			Page &nbsp; :
			<select name="page" class="select">
				<option value=" " selected>(please select a Page)</option>
				<option value="<?php    ?>"><?php       ?></option>
			</select>
			Name &nbsp; : <input type="text" name="nname" class="text1" />
			Type &nbsp; :
			<select name="ftype" class="select">
				<option value=" " selected>(please select a Datatype)</option>
				<option value="<?php    ?>"><?php       ?></option>
			</select><br /><br />
			<input type="submit" value="Add" class="button" />
			(*If you are modifying the front end back end would automatically be mobified)
		  </form><br /><br />
		  <h1>Back end &nbsp; :</h1><br />
		<form action="" method="post">
			Table &nbsp; :
			...
			Column Name &nbsp; : <input type="text" name="cname" class="text1" />
			Type &nbsp; :
